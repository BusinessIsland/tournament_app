...
class ChampionshipParticipantMapper extends ParticipantMapper {
  final String mainSheetName = "Чемпионат ДФО";
  final String appSheetName = "Служебное Чемпионат ДФО";
