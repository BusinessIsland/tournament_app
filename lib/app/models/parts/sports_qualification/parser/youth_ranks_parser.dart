...
import 'package:tournament_app/app/models/parts/sports_qualification/regexp/youth_ranks_regexp.dart';

class FirstYouthRankParser extends SportsQualificationParser {
  SportsQualification? _tryParseAdultRank(String raw) {
    final match = FirstYouthRankRegexp.firstYouthRank.firstMatch(raw);
...
class SecondYouthRankParser extends SportsQualificationParser {
  SportsQualification? _tryParseAdultRank(String raw) {
    final match = SecondYouthRankRegexp.secondYouthRank.firstMatch(raw);
...
class ThirdYouthRankParser extends SportsQualificationParser {
  SportsQualification? _tryParseAdultRank(String raw) {
    final match = ThirdYouthRankRegexp.thirdYouthRank.firstMatch(raw);
